 (function(){
  ...
  // Only bind buttons that open the proj01 gallery
  const openBtns = Array.from(document.querySelectorAll('.open-gallery[data-gallery="proj01"]'));
  const modal = document.getElementById('proj01-gallery');
  if (!modal) return;
